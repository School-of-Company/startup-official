      ...
      <main className="flex-1">
        <section className="relative flex min-h-[70vh] items-center overflow-hidden py-24">
          ...
          <div className="relative mx-auto max-w-content px-6 text-center sm:px-8 lg:px-10">
            ...
            <BackButton className="mt-10 inline-block rounded-full bg-linear-to-r from-accent to-accent-soft px-8 py-4 text-sm font-semibold text-white transition-transform duration-150 ease-out hover:scale-[1.03] active:scale-[0.98]">
              이전 페이지로 돌아가기
            </BackButton>
          </div>
        </section>
