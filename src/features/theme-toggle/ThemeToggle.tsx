...
export default function ThemeToggle({ className = "" }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" className="hidden dark:block">
        <path
          d="M12 3a9 9 0 1 0 9 9c0-.46-.04-.92-.1-1.36a5.389 5.389 0 0 1-4.4 2.26 5.403 5.403 0 0 1-3.14-9.8c-.44-.06-.9-.1-1.36-.1Z"
          fill="currentColor"
        />
      </svg>
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" className="dark:hidden">
